...
public class UserFormControllerTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void save() throws Exception {
		mockMvc.perform(get("/admin-edit-user.html")
				.param("id", "1"))
				.andExpect(status().isOk());
		
		mockMvc.perform(post("/admin-edit-user.html")
				.param("id", "1")
				.param("username", "test")
				.param("email", "test@gmail.com")
				.param("password", "12dea96fec20593566ab75692c9949596833adc9")
				.param("roles", "1", "2"))
				.andExpect(view().name("redirect:admin-edit-user.html?id=1"))
				.andExpect(status().isOk());
	}
